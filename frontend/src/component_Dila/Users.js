...
const Users = () => {
  ...
  const addUser = (data) => {
    ...
    Axios.post('http://localhost:3001/api/createcloth', payload)//http://localhost:3001/api/createuser  https://book-shop-dep.vercel.app/api/createuserv
      .then((response) => {
        getUsers();
        setSubmitted(false);
  ...
  const updateUser = (data) => {
    ...
    Axios.post('http://localhost:3001/api/updatecloth', payload)//http://localhost:3001/api/updateuser  https://book-shop-dep.vercel.app/api/updateuser
      .then((response) => {
        getUsers();
        setSubmitted(false);
        setDisplayTable(true);
  ...
  const deleteUser = (data) => {
    ...
    Axios.post('http://localhost:3001/api/deletecloth', data)//http://localhost:3001/api/deleteuser  https://book-shop-dep.vercel.app/api/deleteuser
      .then((response) => {
        getUsers();
      })
      .catch((error) => {
